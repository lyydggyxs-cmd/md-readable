...
将 Markdown 线性文本转化为人类可空间化消费的 HTML 视图。
...
这是本 skill 区别于所有其他 md-to-html 工具的根本。三层架构不是审美选择——它**补偿了 AI 文本的三种结构性缺陷**（来自认知科学和 HCI 研究）：
...
这是本 skill 与所有其他 md-to-html 工具的根本差异——不是模板套用，而是语义重组。
...
3. 判断模式：
   - 文档 > 500 字 + 有论证结构 → **简报模式**（完整 SCQA + 三层）
...
这些视觉做法在 HTML 简报中**禁止**。每一条都服务于一个明确的设计原则：
